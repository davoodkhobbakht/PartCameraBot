...
ask_payment_image = "🖼 تصویر رسید پرداختی خود را ارسال نمایید\n" \
                    "\n" \
                    "<i>مبالغ را فقط به شماره کارت 3343-7498-1010-5892 واریز نمایید.</i>"
...
fatal_conversation_exception = "<b>خطا</b>\n" \
                               "اسکرین شات این خطا را به برنامه نویس : @Davoodkhobbakht ارسال کنیپ تا بتواند آن را برطرف کند.\n" \
